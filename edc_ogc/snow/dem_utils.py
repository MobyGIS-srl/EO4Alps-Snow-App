...
@njit
def horneslope(indem, dem_pixel_size, deg=True):
    ...
    if isinstance(dem_pixel_size, (int, float)):
        dem_pixel_size = (dem_pixel_size, dem_pixel_size)
