    ...
    def process_image(self, sources, bbox, crs, width, height, format, evalscript,
        ...
        request_body = {
            'input': {
                'bounds': {
                    'bbox': bbox,
                    # 'geometry': "POLYGON((10.818481445312504 46.183998511554854,10.819854736328129 46.06120967232227,10.950317382812504 46.10312188963909,11.005249023437504 46.21346512469023,10.944824218750004 46.31884502759984,10.862426757812504 46.270452390195665,10.818481445312504 46.183998511554854))",
                    # "geometry": {
                    #     "type": "Polygon",
                    #     "coordinates": [
                    #       [
